        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (verified_credentials){
                ...
                try {
                    ...
                    this.stored_info.update_logged_in_user(username);
                    this.stored_info.get_inital_user_counts_from_db();
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                if (isResultSet) {
                    ...
                    this.stored_info.increment_query_count();
                } else {
                    ...
                    if (updateCount == -1) {
                        ...
                        this.stored_info.increment_update_count();
                    }
                }
